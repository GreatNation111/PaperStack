...
export function Welcome({ onSignIn, onSignUp }: WelcomeProps) {
  ...
  return (
    <div className="fixed inset-0 bg-white overflow-hidden">
      ...
      <motion.div
        className="absolute top-0 left-0 right-0 bottom-[50vh] flex flex-col items-center justify-center px-8 z-0 bg-cover bg-[center_top_20%] bg-no-repeat before:content-[''] before:absolute before:inset-0 before:bg-[rgba(255,255,255,0.55)] before:backdrop-blur-[1px] before:brightness-105 before:-z-10"
